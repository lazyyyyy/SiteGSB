...
<body class="right-sidebar">
	...
	<div id="page-wrapper">
			...
			<div class="container" id="contenu">
                <div class="row">
					<div class="col-lg-2 col-xs-2 text-right">
                        <label style="font-weight:bold;">Date de départ </label>
                    </div>
                    <div id="dateDepart"></div>
				</div>
                <div class="row">
					<div class="col-lg-2 col-xs-2 text-right">
                        <label style="font-weight:bold;">Date de retour </label>
                    </div>
                    <div id="dateRetour"></div>
				</div>
                <div class="row">
					<div class="col-lg-2 col-xs-2 text-right">
                        <label style="font-weight:bold;">Parc automobile de départ </label>
                    </div>
                    <div id="parcAutoDepart"></div>
				</div>
                <div class="row">
					<div class="col-lg-2 col-xs-2 text-right">
                        <label style="font-weight:bold;">Parc automobile d'arrivée </label>
                    </div>
                    <div id="ParcAutoArrivee"></div>
				</div>
                <div class="row">
					<div class="col-lg-2 col-xs-2 text-right">
                        <label style="font-weight:bold;">Distance parcourue </label>
                    </div>
                    <div id="distance"></div>
				</div>
                <h1>Vehicule</h1>
        ...
        <script src="js/reservationAncienne.js"></script>
