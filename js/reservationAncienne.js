...
ajaxPost("http://localhost:8080/api/getReservationById.php", data2, function(reponse2){
    ...
    document.getElementById("dateRetour").textContent = reservation.date_arrivee;
    ...
    document.getElementById("ParcAutoArrivee").textContent = reservation.parc_auto_arrivee.libelle + "(" + reservation.parc_auto_arrivee.lieu.adresse + ", " + reservation.parc_auto_arrivee.lieu.cp + " " + reservation.parc_auto_arrivee.lieu.ville + ", " + reservation.parc_auto_arrivee.lieu.pays;
    document.getElementById("distance").textContent = reservation.distance_parcourue;
