	...
	<div id="page-wrapper">
		...
		<div class="wrapper style1">
            ...
            if(strtoupper($user->fonction_utilisateur->libelle) == "ADMINISTRATEUR")
            {
                ?>
                <div id="boutons">
                    <a href="modifierUtilisateur.php?id=<?php echo $_GET["id"] ?>" ><button>Modifier</button></a>
                    <button id="supprimer">Supprimer</button>
                    <button id="reinitialiserMdp">Réinitialiser mot de passe</button>
                </div>
                <?php
            }
            ?>
			...
			<div class="container">
                ...
                <div class="row" id="dateNaissance">
					<div class="col-lg-2 col-xs-2 text-right">
						<label style="font-weight:bold;">Date de naissance </label>
					</div>
					
				</div>
                <div class="row" id="dateEmbauche">
					<div class="col-lg-2 col-xs-2 text-right">
						<label style="font-weight:bold;">Date d'embauche </label>
					</div>
                ...
                <div class="row" id="droit">
					<div class="col-lg-2 col-xs-2 text-right">
						<label style="font-weight:bold;">Droit </label>
					</div>
        ...
        <script src="js/utilisateurDetails.js" ></script>
